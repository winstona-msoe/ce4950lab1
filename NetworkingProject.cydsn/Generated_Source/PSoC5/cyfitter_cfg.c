...
#define BS_IOPINS0_0_VAL ((const uint8 CYFAR *)0x480001CCu)

/* IOPINS0_8 Address: CYREG_PRT15_DR Size (bytes): 10 */
#define BS_IOPINS0_8_VAL ((const uint8 CYFAR *)0x480001D4u)
...
#define BS_IOPINS0_3_VAL ((const uint8 CYFAR *)0x480001E8u)
