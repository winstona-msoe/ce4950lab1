...
#define BS_IOPINS0_8_VAL ((const uint8 CYFAR *)0x48000310u)
...
#define BS_IOPINS0_3_VAL ((const uint8 CYFAR *)0x48000324u)

/* IOPINS0_4 Address: CYREG_PRT4_DM0 Size (bytes): 8 */
#define BS_IOPINS0_4_VAL ((const uint8 CYFAR *)0x4800032Cu)
