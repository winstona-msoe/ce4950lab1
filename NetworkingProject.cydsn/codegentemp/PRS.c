        ...
        *******************************************************************************/
                                            ...
                                            
        {
            ...
            enableInterrupts = CyEnterCriticalSection();
                ...
                /* Write Seed COPY */
                CY_SET_REG8(PRS_SEED_COPY_PTR, seed);
    ...
    *******************************************************************************/
    uint8 PRS_Read(void) 
    {
        /* Read PRS */
            ...
            return (CY_GET_REG8(PRS_SEED_PTR) & PRS_MASK);
    ...
    *******************************************************************************/
                                ...
                                
    {
        /* Reads polynomial */
            ...
            return CY_GET_REG8(PRS_POLYNOM_PTR);
    ...
    *******************************************************************************/
                                          ...
                                          
    {
        ...
        /* Write polynomial */
            ...
            CY_SET_REG8(PRS_POLYNOM_PTR, polynomial);
