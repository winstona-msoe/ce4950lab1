...
module top ;
    ...
    defparam TimerRX.CaptureCounterEnabled = 0;
	...
	cy_clock_v1_0
		#(.id("706541ad-4208-4e22-b323-dc4cb7946d0e"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("10000000000"),
		  .is_direct(0),
	...
	wire [0:0] tmpIO_0__RiseEdge_net;
	wire [0:0] tmpINTERRUPT_0__RiseEdge_net;
	electrical [0:0] tmpSIOVREF__RiseEdge_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("c7205184-884b-414a-a267-34694b1e0a1d"),
		  ...
		  .input_buffer_sel(2'b00))
		RiseEdge
		 (.oe(tmpOE__RiseEdge_net),
		  .y({Net_66}),
		  .fb({tmpFB_0__RiseEdge_net[0:0]}),
		  .io({tmpIO_0__RiseEdge_net[0:0]}),
		  .siovref(tmpSIOVREF__RiseEdge_net),
		  .interrupt({tmpINTERRUPT_0__RiseEdge_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	wire [0:0] tmpOE__FallEdge_net;
	wire [0:0] tmpFB_0__FallEdge_net;
	wire [0:0] tmpIO_0__FallEdge_net;
	wire [0:0] tmpINTERRUPT_0__FallEdge_net;
	electrical [0:0] tmpSIOVREF__FallEdge_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		FallEdge
		 (.oe(tmpOE__FallEdge_net),
		  .y({Net_71}),
		  .fb({tmpFB_0__FallEdge_net[0:0]}),
		  .io({tmpIO_0__FallEdge_net[0:0]}),
		  .siovref(tmpSIOVREF__FallEdge_net),
		  .interrupt({tmpINTERRUPT_0__FallEdge_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__FallEdge_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__ReceiveLight_net;
	wire [0:0] tmpFB_0__ReceiveLight_net;
	wire [0:0] tmpIO_0__ReceiveLight_net;
	wire [0:0] tmpINTERRUPT_0__ReceiveLight_net;
	electrical [0:0] tmpSIOVREF__ReceiveLight_net;

	cy_psoc3_pins_v1_10
		#(.id("34a4d25f-c58e-468e-9678-68185a4cfc35"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		ReceiveLight
		 (.oe(tmpOE__ReceiveLight_net),
		  .y({Net_172}),
		  .fb({tmpFB_0__ReceiveLight_net[0:0]}),
		  .io({tmpIO_0__ReceiveLight_net[0:0]}),
		  .siovref(tmpSIOVREF__ReceiveLight_net),
		  .interrupt({tmpINTERRUPT_0__ReceiveLight_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ReceiveLight_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
