...
/* CollisionISR */
#define CollisionISR__INTC_CLR_EN_REG CYREG_NVIC_CLRENA0
#define CollisionISR__INTC_CLR_PD_REG CYREG_NVIC_CLRPEND0
#define CollisionISR__INTC_MASK 0x01u
#define CollisionISR__INTC_NUMBER 0u
#define CollisionISR__INTC_PRIOR_NUM 7u
#define CollisionISR__INTC_PRIOR_REG CYREG_NVIC_PRI_0
#define CollisionISR__INTC_SET_EN_REG CYREG_NVIC_SETENA0
#define CollisionISR__INTC_SET_PD_REG CYREG_NVIC_SETPEND0
...
/* TimerCollision */
#define TimerCollision_TimerHW__CAP0 CYREG_TMR0_CAP0
#define TimerCollision_TimerHW__CAP1 CYREG_TMR0_CAP1
#define TimerCollision_TimerHW__CFG0 CYREG_TMR0_CFG0
#define TimerCollision_TimerHW__CFG1 CYREG_TMR0_CFG1
#define TimerCollision_TimerHW__CFG2 CYREG_TMR0_CFG2
#define TimerCollision_TimerHW__CNT_CMP0 CYREG_TMR0_CNT_CMP0
#define TimerCollision_TimerHW__CNT_CMP1 CYREG_TMR0_CNT_CMP1
#define TimerCollision_TimerHW__PER0 CYREG_TMR0_PER0
#define TimerCollision_TimerHW__PER1 CYREG_TMR0_PER1
#define TimerCollision_TimerHW__PM_ACT_CFG CYREG_PM_ACT_CFG3
#define TimerCollision_TimerHW__PM_ACT_MSK 0x01u
#define TimerCollision_TimerHW__PM_STBY_CFG CYREG_PM_STBY_CFG3
#define TimerCollision_TimerHW__PM_STBY_MSK 0x01u
#define TimerCollision_TimerHW__RT0 CYREG_TMR0_RT0
#define TimerCollision_TimerHW__RT1 CYREG_TMR0_RT1
#define TimerCollision_TimerHW__SR0 CYREG_TMR0_SR0
...
#define TimerRX_TimerUDB_rstSts_stsreg__MASK_ST_AUX_CTL_REG CYREG_B1_UDB05_MSK_ACTL
#define TimerRX_TimerUDB_rstSts_stsreg__PER_ST_AUX_CTL_REG CYREG_B1_UDB05_MSK_ACTL
#define TimerRX_TimerUDB_rstSts_stsreg__STATUS_AUX_CTL_REG CYREG_B1_UDB05_ACTL
#define TimerRX_TimerUDB_rstSts_stsreg__STATUS_CNT_REG CYREG_B1_UDB05_ST_CTL
#define TimerRX_TimerUDB_rstSts_stsreg__STATUS_CONTROL_REG CYREG_B1_UDB05_ST_CTL
#define TimerRX_TimerUDB_rstSts_stsreg__STATUS_REG CYREG_B1_UDB05_ST
#define TimerRX_TimerUDB_sCTRLReg_SyncCtl_ctrlreg__16BIT_CONTROL_AUX_CTL_REG CYREG_B1_UDB05_06_ACTL
#define TimerRX_TimerUDB_sCTRLReg_SyncCtl_ctrlreg__16BIT_CONTROL_CONTROL_REG CYREG_B1_UDB05_06_CTL
#define TimerRX_TimerUDB_sCTRLReg_SyncCtl_ctrlreg__16BIT_CONTROL_COUNT_REG CYREG_B1_UDB05_06_CTL
#define TimerRX_TimerUDB_sCTRLReg_SyncCtl_ctrlreg__16BIT_COUNT_CONTROL_REG CYREG_B1_UDB05_06_CTL
#define TimerRX_TimerUDB_sCTRLReg_SyncCtl_ctrlreg__16BIT_COUNT_COUNT_REG CYREG_B1_UDB05_06_CTL
#define TimerRX_TimerUDB_sCTRLReg_SyncCtl_ctrlreg__16BIT_MASK_MASK_REG CYREG_B1_UDB05_06_MSK
#define TimerRX_TimerUDB_sCTRLReg_SyncCtl_ctrlreg__16BIT_MASK_PERIOD_REG CYREG_B1_UDB05_06_MSK
#define TimerRX_TimerUDB_sCTRLReg_SyncCtl_ctrlreg__16BIT_PERIOD_MASK_REG CYREG_B1_UDB05_06_MSK
#define TimerRX_TimerUDB_sCTRLReg_SyncCtl_ctrlreg__16BIT_PERIOD_PERIOD_REG CYREG_B1_UDB05_06_MSK
...
#define TimerRX_TimerUDB_sCTRLReg_SyncCtl_ctrlreg__CONTROL_AUX_CTL_REG CYREG_B1_UDB05_ACTL
#define TimerRX_TimerUDB_sCTRLReg_SyncCtl_ctrlreg__CONTROL_REG CYREG_B1_UDB05_CTL
#define TimerRX_TimerUDB_sCTRLReg_SyncCtl_ctrlreg__CONTROL_ST_REG CYREG_B1_UDB05_ST_CTL
#define TimerRX_TimerUDB_sCTRLReg_SyncCtl_ctrlreg__COUNT_REG CYREG_B1_UDB05_CTL
#define TimerRX_TimerUDB_sCTRLReg_SyncCtl_ctrlreg__COUNT_ST_REG CYREG_B1_UDB05_ST_CTL
#define TimerRX_TimerUDB_sCTRLReg_SyncCtl_ctrlreg__MASK 0x80u
#define TimerRX_TimerUDB_sCTRLReg_SyncCtl_ctrlreg__MASK_CTL_AUX_CTL_REG CYREG_B1_UDB05_MSK_ACTL
#define TimerRX_TimerUDB_sCTRLReg_SyncCtl_ctrlreg__PER_CTL_AUX_CTL_REG CYREG_B1_UDB05_MSK_ACTL
#define TimerRX_TimerUDB_sCTRLReg_SyncCtl_ctrlreg__PERIOD_REG CYREG_B1_UDB05_MSK
...
#define TimerRX_TimerUDB_sT16_timerdp_u1__MSK_DP_AUX_CTL_REG CYREG_B1_UDB05_MSK_ACTL
#define TimerRX_TimerUDB_sT16_timerdp_u1__PER_DP_AUX_CTL_REG CYREG_B1_UDB05_MSK_ACTL

/* TimerTX */
#define TimerTX_TimerHW__CAP0 CYREG_TMR1_CAP0
#define TimerTX_TimerHW__CAP1 CYREG_TMR1_CAP1
#define TimerTX_TimerHW__CFG0 CYREG_TMR1_CFG0
#define TimerTX_TimerHW__CFG1 CYREG_TMR1_CFG1
#define TimerTX_TimerHW__CFG2 CYREG_TMR1_CFG2
#define TimerTX_TimerHW__CNT_CMP0 CYREG_TMR1_CNT_CMP0
#define TimerTX_TimerHW__CNT_CMP1 CYREG_TMR1_CNT_CMP1
#define TimerTX_TimerHW__PER0 CYREG_TMR1_PER0
#define TimerTX_TimerHW__PER1 CYREG_TMR1_PER1
#define TimerTX_TimerHW__PM_ACT_CFG CYREG_PM_ACT_CFG3
#define TimerTX_TimerHW__PM_ACT_MSK 0x02u
#define TimerTX_TimerHW__PM_STBY_CFG CYREG_PM_STBY_CFG3
#define TimerTX_TimerHW__PM_STBY_MSK 0x02u
#define TimerTX_TimerHW__RT0 CYREG_TMR1_RT0
#define TimerTX_TimerHW__RT1 CYREG_TMR1_RT1
#define TimerTX_TimerHW__SR0 CYREG_TMR1_SR0

/* TransmitISR */
#define TransmitISR__INTC_CLR_EN_REG CYREG_NVIC_CLRENA0
#define TransmitISR__INTC_CLR_PD_REG CYREG_NVIC_CLRPEND0
#define TransmitISR__INTC_MASK 0x40000u
#define TransmitISR__INTC_NUMBER 18u
#define TransmitISR__INTC_PRIOR_NUM 7u
#define TransmitISR__INTC_PRIOR_REG CYREG_NVIC_PRI_18
...
/* collision_clock */
#define collision_clock__CFG0 CYREG_CLKDIST_DCFG3_CFG0
#define collision_clock__CFG1 CYREG_CLKDIST_DCFG3_CFG1
#define collision_clock__CFG2 CYREG_CLKDIST_DCFG3_CFG2
#define collision_clock__CFG2_SRC_SEL_MASK 0x07u
#define collision_clock__INDEX 0x03u
#define collision_clock__PM_ACT_CFG CYREG_PM_ACT_CFG2
#define collision_clock__PM_ACT_MSK 0x08u
#define collision_clock__PM_STBY_CFG CYREG_PM_STBY_CFG2
#define collision_clock__PM_STBY_MSK 0x08u
