...
{
   #if(TimerTX_UsingFixedFunction)
       return ((uint8)CY_GET_REG16(TimerTX_PERIOD_LSB_PTR));
   #else
       return (CY_GET_REG8(TimerTX_PERIOD_LSB_PTR));
   #endif /* (TimerTX_UsingFixedFunction) */
}
...
void TimerTX_WritePeriod(uint8 period) 
{
    ...
    #else
        CY_SET_REG8(TimerTX_PERIOD_LSB_PTR, period);
...
{
   #if(TimerTX_UsingFixedFunction)
       return ((uint8)CY_GET_REG16(TimerTX_CAPTURE_LSB_PTR));
   #else
       return (CY_GET_REG8(TimerTX_CAPTURE_LSB_PTR));
   #endif /* (TimerTX_UsingFixedFunction) */
}
...
void TimerTX_WriteCounter(uint8 counter) 
{
    ...
    #else
        CY_SET_REG8(TimerTX_COUNTER_LSB_PTR, counter);
