...
# Date: Mon, 08 Jan 2018 18:37:25 GMT
#set_units -time ns
...
create_generated_clock -name {CLOCK2} -source [get_pins {ClockBlock/clk_sync}] -edges {1 321 641} -nominal_period 13333.333333333332 [list [get_pins {ClockBlock/dclk_glb_1}]]
